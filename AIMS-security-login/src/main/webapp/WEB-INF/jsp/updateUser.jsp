	...
	<body>
		...
		<section class="body_section">			
			<div id="addUser" class="container">
				<h3 class="ml-0 mt-3" style="color: red;">Alter User</h3>
				<form:form action="/updateUser" method="post"
					...
					<div class="form-group row">
					    ...
					    <div class="col-sm-3">
					    	<form:input cssClass="form-control" path="userId" value="${user.userId}" readonly="true" />
					    </div>				    
					 </div>	
					 <div class="form-group row">
					    <label class="control-label col-sm-2">Enter User Name</label>
					    <div class="col-sm-3">
					    	<form:input cssClass="form-control" path="userName" value="${user.userName}" readonly="true" />
					    </div>				    
					 </div>
					 <div class="form-group row">
					    <label class="control-label col-sm-2">Enter Clone ID</label>
					    <div class="col-sm-3">
					    	<form:input cssClass="form-control" path="cloneId" autofocus="true" value="${user.cloneId}" />
					    </div>				    
					 </div>
